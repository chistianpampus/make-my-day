...
export class TaskService {
  ...
  static async updateTask(id: number, data: Partial<{ completed: boolean, isLocked: boolean, title: string, timeConstraint: string | null, scheduledStartTime: string | null, priority: string, estimatedDuration: number | null, scheduledDate: string | null }>) {
